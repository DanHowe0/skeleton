...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Button ID="btnCancel" runat="server" height="26px" style="z-index: 1; left: 259px; top: 240px; position: absolute; width: 53px" Text="Cancel" OnClick="btnCancel_Click" />
